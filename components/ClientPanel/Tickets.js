      ...
      <FlatList style={styles.Container}
        ...
        renderItem={({ item }) => (
          <ListItem
           ...
           onPress={() => this.props.navigation.navigate('Views', {Title: item.title, Description: item.description, OP: item.username , Username: this.props.navigation.getParam('Username'), ID: item.id})}
          />
        )}
